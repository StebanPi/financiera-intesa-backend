...
<head>
    ...
    <title>Recibo POS {{ $paperWidth }} - Otros Ingresos</title>
...
<body>
    <div class="receipt-container">
        ...
        <div class="receipt-body">
            ...
            @if(isset($persona_cedula) && $persona_cedula)
                <div class="field">
                    ...
                    <div class="field-value">{{ $persona_cedula }}</div>
                </div>
            @endif
            ...
            @if(isset($persona_nombre) && $persona_nombre)
                <div class="field">
                    ...
                    <div class="field-value">{{ strtoupper($persona_nombre) }}</div>
                </div>
            @endif
