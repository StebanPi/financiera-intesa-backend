...
@section('content')
    ...
    <table id="table" style="width: 100%; font-size: 12px; border: 1px solid black;" class=""> 
        <thead class="thead-secondary text-black text-center">
            <tr style="background-color: #ffffff;color:#000; font-size: 12px;">
                <th colspan="5" style="text-align:center; padding: 4px 3px; font-weight: 700; border: 1px solid black; background-color: #e9ecef;">Abonos a matricula</th>
            </tr>
            <tr style="background-color: #a6c307;color:white;">
                ...
                <th scope="col" style="width: 22%; padding: 4px 3px; border: 1px solid black;">Comentario</th>
        ...
        <tbody>
            @if(isset($entries) && count($entries) > 0)
                ...
                @endforeach
            @else
                {{-- Agregar fila vacía cuando no hay abonos a matrícula para que se vean los bordes correctamente --}}
                <tr>
            ...
            <tr style="background-color: #CBF993; font-size: 12px;">
                <td style="text-align:center; padding: 3px; border: 1px solid black;"></td>
                <td style="text-align:center; padding: 3px; border: 1px solid black;"></td>
                <td style="text-align:center; padding: 3px; border: 1px solid black;"></td>
            ...
            <tr style="background-color: #F9BBB0; font-size: 12px;">
                <td style="text-align:center; padding: 3px; border: 1px solid black;"></td>
                <td style="text-align:center; padding: 3px; border: 1px solid black;"></td>
                <td style="text-align:center; padding: 3px; border: 1px solid black;"></td>
    ...
    <table id="table" style="width: 100%; font-size: 12px; margin-top: 8px; border: 1px solid black;" class=""> 
        <thead class="thead-secondary text-black text-center">
            <tr style="background-color: #ffffff;color:#000; font-size: 12px;">
                <th colspan="5" style="text-align:center; padding: 4px 3px; font-weight: 700; border: 1px solid black; background-color: #e9ecef;">Otros Abonos</th>
            </tr>
            <tr style="background-color: #a6c307;color:white;">
                <th scope="col" style="width: 15%; padding: 4px 3px; border: 1px solid black;">No. Recibo</th>
                <th scope="col" style="width: 18%; padding: 4px 3px; border: 1px solid black;">Fecha</th>
        ...
        <tbody>
            @if(isset($others) && count($others) > 0)
                ...
                @endforeach
            @else
                {{-- Agregar fila vacía cuando no hay otros abonos para que se vean los bordes correctamente --}}
                <tr>
                    <td style="text-align:center; padding: 8px; border: 1px solid black; color: #999;">Sin otros abonos registrados</td>
                    <td style="text-align:center; padding: 8px; border: 1px solid black;"></td>
                    <td style="text-align:center; padding: 8px; border: 1px solid black;"></td>
                    <td style="text-align:center; padding: 8px; border: 1px solid black;"></td>
                    <td style="text-align:center; padding: 8px; border: 1px solid black;"></td>
        ...
        <tfoot>
            <tr style="background-color: #E3FBC3; font-size: 12px;">
                ...
                <td style="text-align: center; padding: 3px; border: 1px solid black;"></td>
                <td style="text-align: center; padding: 3px; border: 1px solid black;"></td>
                <td style="text-align: center; padding: 3px; border: 1px solid black; font-weight: 600;">Total</td>
                <td style="text-align: right; padding: 3px; border: 1px solid black; font-weight: 600;">${{ App\Http\Controllers\MoneyController::main($suma) }}</td>
            </tr>
        </tfoot>
    </table>
    ...
    <table style="width: 100%; font-size: 12px; margin-top: 8px; border-collapse: collapse; border: 1px solid black;">
        <thead class="thead-secondary text-black text-center">
            <tr style="background-color: #ffffff;color:#000; font-size: 12px;">
                <th colspan="5" style="text-align:center; padding: 4px 3px; font-weight: 700; border: 1px solid black; background-color: #e9ecef;">Total Cancelado (Abonos a matricula + Otros Abonos)</th>
            </tr>
        </thead>
        <tbody>
            <tr style="background-color:#E3FBC3;color:#000; font-size: 12px;">
                <th colspan="4" style="padding: 3px; border: 1px solid black; text-align: left; font-weight: 600;">Total</th>
                <th scope="col" style="text-align: right; padding: 3px; border: 1px solid black; font-weight: 600;">${{ App\Http\Controllers\MoneyController::main($sumaTotal) }}</th>
            </tr>
        </tbody>    
    </table>
