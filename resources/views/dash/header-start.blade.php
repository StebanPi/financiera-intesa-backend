            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown d-none">
                        <a class="nav-link primary" href="{{ route('cloud.synchronization') }}">
                            22
                        </a>
                    </li>
                    <li class="nav-item dropdown notification_dropdown d-none">
                        <a class="nav-link primary" href="{{ route('cloud.synchronization') }}">
                            <img src="{{ asset('dimages/internet.png') }}" alt="" height="22" width="22">
                        </a>
                    </li>
                    <li class="nav-item dropdown notification_dropdown d-none">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <div class="header-info">
                                <span>Hola, <strong>Kelvin</strong></span>
                            </div>
                            <img src="https://ui-avatars.com/api/?name=SebastyanPineda&background=98ce04&color=fff&size=128" width="20" alt=""/>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
