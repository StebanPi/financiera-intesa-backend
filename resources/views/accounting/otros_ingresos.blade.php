    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('accounting.otros-ingresos') }}" class="mb-4">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('accounting.otros-ingresos.download', ['fecha_inicio' => $fecha_inicio, 'fecha_fin' => $fecha_fin]) }}" 
                            ...
                            <table class="table table-bordered table-striped table-hover" style="margin-bottom: 0;">
                                <thead class="thead-secondary" style="position: sticky; top: 0; z-index: 10; background-color: #6c757d !important;">
                                    <tr>
                                        ...
                                        <th style="width: 10%;">Fecha Recibo</th>
                                ...
                                <tbody>
                                    @foreach($dataset['grouped'] as $concepto => $programas)
                                        <tr style="background-color: #0d6efd; color: #fff;">
                                            <td colspan="8" class="font-weight-bold" style="padding: 12px;">
                                        ...
                                        @foreach($programas as $programa => $items)
                                            ...
                                            <tr style="background-color: #e9ecef; font-weight: bold;">
                                                <td colspan="7" class="text-right" style="padding: 10px;">Subtotal {{ $programa }}</td>
                                        ...
                                        <tr style="background-color: #0dcaf0; font-weight: bold;">
                                            <td colspan="7" class="text-right" style="padding: 12px;">SUBTOTAL {{ $concepto }}</td>
                                            @php
                                                $conceptoTotal = 0;
                                                foreach($programas as $items) {
                                                    $conceptoTotal += array_sum(array_column($items, 'valor'));
                                                }
                                            @endphp
                                            <td class="text-right" style="padding: 12px;">
                                                ${{ number_format($conceptoTotal, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr><td colspan="8" style="padding: 5px; border: none;"></td></tr>
                                    @endforeach
                                    <tr style="background-color: #d1e7dd; font-weight: bold; font-size: 1.05em;">
                                        <td colspan="7" class="text-right" style="padding: 12px;">TOTAL GENERAL</td>
                                        <td class="text-right" style="padding: 12px;">
