    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('accounting.informe-mensual') }}" class="mb-4">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Mes y Año</label>
                                <input type="month" name="month_year" class="form-control" value="{{ isset($mes) && isset($anio) ? sprintf('%04d-%02d', $anio, $mes) : '' }}" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a href="{{ route('accounting.informe-mensual.download', ['mes' => $mes, 'anio' => $anio]) }}" 
                ...
                @if(isset($dataset))
                    ...
                    @else
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle mr-2"></i>No se encontraron registros para el mes seleccionado.
                        </div>
                    @endif
                @endif
            </div>
