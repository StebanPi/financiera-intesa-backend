...
class OtherEntryResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'numero_semestre' => $this->cost->numero_semestre ?? null,
            'concepto' => $this->concepto,
            'concepto_nombre' => $this->conceptoObj->nombre ?? '',
            ...
            'elaborado_por_nombre' => $this->elaboradoObj->nombre ?? '',
            'debe' => $this->debe,
            'haber' => $this->haber,
