...
jQuery(window).on("load", function() {
    ...
    //     });
    // }
	// Inicializar selectpicker solo en selects que NO tengan la clase no-selectpicker o el atributo data-no-selectpicker
	$('select').not('.no-selectpicker').not('[data-no-selectpicker="true"]').selectpicker();
});
